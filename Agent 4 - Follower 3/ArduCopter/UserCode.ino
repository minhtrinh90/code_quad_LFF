...
//              set_nav_mode(LOITER_NAV);
      ...
      else if(New_Flight_mode_ON==STATE_CONTROLLED)
      {
          ...
          lat_dist_from_agent3 = 0.0001*((float)(xb_data_f[2].data[0]) - (float)(current_loc.lat%1000000));
          lng_dist_from_agent3 = 0.0001*((float)(xb_data_f[2].data[1]) - (float)(current_loc.lng%1000000));         
          ...
          bearing_x_3 = cntrl_gain*lat_dist_from_agent3/sqrt(lat_dist_from_agent3*lat_dist_from_agent3 + lng_dist_from_agent3*lng_dist_from_agent3);
          bearing_y_3 = cntrl_gain*lng_dist_from_agent3/sqrt(lat_dist_from_agent3*lat_dist_from_agent3 + lng_dist_from_agent3*lng_dist_from_agent3);  

          control_input_x = -0.5*((-bearing_x_2d * bearing_y_2 + bearing_y_2d * bearing_x_2)*(-bearing_y_2) + (-bearing_x_3d * bearing_y_3 + bearing_y_3d * bearing_x_3)*(-bearing_y_3));
          control_input_y = -0.5*((-bearing_x_2d * bearing_y_2 + bearing_y_2d * bearing_x_2)*bearing_x_2 + (-bearing_x_3d * bearing_y_3 + bearing_y_3d * bearing_x_3)*bearing_x_3);
