...
#define bearing_x_2d 0.0
#define bearing_y_2d 1.0
#define bearing_x_3d 1.0
#define bearing_y_3d 0.0
...
float bearing_x_2, bearing_x_3;
float bearing_y_2, bearing_y_3;
